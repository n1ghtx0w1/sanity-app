...
export default function Home({ posts }: Props) {
  return (
    <div className="max-w-7xl mx-auto">
     ...
     <div className='flex justify-between items-center shadow-lg bg-blue-400 border-y border-black py-10 lg:py-0'>
     ...
     <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 p-2 md:p-6'>
      {posts.map((post) => (
        <Link key={post._id} href={`/post/${post.slug.current}`}>
          <div className='border rounded-lg shadow-md group coursor-pointer overflow-hidden'>
